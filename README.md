...
La climatisation et le chauffage regroupent les radiateurs (le plus souvent à eau), les ventilo-convecteurs ou encore des panneaux rayonnants. Ces équipements reposent sur des réseaux de chaleurs/fraicheur alimentés par des pompes de différents tailles selon le mode de distribution. 
